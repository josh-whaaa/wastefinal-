...
if (!isset($_SESSION['client_id']) || $_SESSION['user_role'] !== 'client') {
    // If not a client, redirect to login
...
// Check if user is a driver (should not happen, but for safety)
$isDriver = isset($_SESSION['driver_id']) && $_SESSION['user_role'] === 'driver';
?>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                ...
                href="<?php echo $isDriver ? '../dashboard_management/driver_dashboard.php' : '../dashboard_management/client_dashboard.php'; ?>">
            ...
            <?php endif; ?>
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'client_notifications.php' || $current_page == 'drivers_notification.php') ? 'active bg-gradient-dark text-white' : 'text-light'; ?>" href="<?php echo $isDriver ? '../admin_management/drivers_notification.php' : '../client_management/client_notifications.php'; ?>">
